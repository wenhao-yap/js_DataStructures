...
/*--------------------------- 
	...
	Time complexity: O(n^2) 
 	Submission Error: Output Limit Exceeded
 		Failed test case: 
...
/*--------------------------- 
	...
	Reason: 
		To improve run time complexity, a more efficient way to check if the complement exists in array. 
		Beware that the complement must not be nums[i] itself
	Time complexity: O(n) 
	Status: Success
		Runtime: 60 ms, faster than 74.35% of JavaScript online submissions for Two Sum.
---------------------------*/
